    ...
    <div class="max-w-6xl mx-auto py-6 sm:px-6 lg:px-8"> <!-- Adjusted max-w to make it wider -->
        <div class="bg-white overflow-hidden shadow sm:rounded-lg">
            ...
            <div class="px-4 py-3 flex justify-between sm:px-6">
                <!-- Back Button -->
                <a href="{{ route('jobs.index') }}" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-red-500 hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                    Back
                </a>
                <!-- Apply for Job Button -->
                <a href="{{ route('jobs.apply', $job->id) }}" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-green-500 hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                    Apply for Job
                </a>
            </div>
        </div>
