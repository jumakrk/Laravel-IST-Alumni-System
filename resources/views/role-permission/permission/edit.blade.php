                    ...
                    <div class="p-4">
                        <form action="{{ url('permissions/'.$permission->id) }}" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="name" value="{{ $permission->name }}" id="name" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Enter permission name">
                            </div>
                            {{-- Button --}}
