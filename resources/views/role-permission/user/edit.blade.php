        ...
        <div class="bg-white shadow-md rounded-lg">
            <div class="bg-gray-100 p-4 border-b">
                <h4 class="text-lg font-semibold flex justify-between items-center">
                    Edit User
                    <a href="{{ url('users') }}" class="bg-red-600 hover:bg-red-500 text-white font-bold py-2 px-4 text-sm rounded-full">Back</a>
                </h4>
            </div>
            <div class="p-6">
                        ...
                        <div class="space-y-2">
                            @foreach ($roles as $role)
                                <div class="flex items-center">
                                    ...
                                    <label for="role-{{ $role }}" class="text-gray-700 text-sm">{{ $role }}</label>
                                </div>
                            @endforeach
                        </div>
